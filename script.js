...
/* =====================================================
   V43 — KNOCKOUT DIRECTIONAL TOUCH HANDLER
   Vertical gestures stay with the page. Horizontal gestures scroll
   the bracket only, preventing the bracket from becoming a vertical
   nested scroll area on iPad/iPhone.
===================================================== */
(() => {
    document.querySelectorAll('.brackets-section .knockout-scroll').forEach(scroller => {
        let startX = 0;
        let startY = 0;
