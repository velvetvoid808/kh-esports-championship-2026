...
/* =====================================================
   TENTATIVE FLOW MODAL — SCHEDULE ADDITION
===================================================== */
...
(() => {
    ...
    const backdrop = modal ? modal.querySelector("[data-close-tentative-flow]") : null;
    ...
    function closeTentativeFlow() {
        /* Keep the page scroll-locked until the modal's exit animation
           has completely finished. This prevents the underlying page
           from reflowing halfway through the close animation. */
        modal.classList.remove("open");

        window.setTimeout(() => {
            modal.hidden = true;
            document.body.classList.remove("tentative-flow-open");
            /* Intentionally do not restore focus here. On iPad/Safari,
               focusing the trigger can cause an unwanted scroll jump. */
        }, 380);
    }
