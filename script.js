...
(() => {
    ...
    /* =====================================================
       TOURNAMENT BRACKETS — ADDITION ONLY
    ...
    function setBracket(title) {
        ...
        bracketTabs.forEach(tab => {
            ...
            const active =
                tab.getAttribute("data-bracket-tab") === title;
        ...
        bracketPanels.forEach(panel => {
            ...
            const active =
                panel.getAttribute("data-bracket-panel") === title;
    ...
    bracketTabs.forEach(tab => {
        ...
        tab.addEventListener(
            ...
            event => {
                ...
                setBracket(
                    tab.getAttribute("data-bracket-tab")
                );
        ...
        tab.addEventListener(
            ...
            event => {
                ...
                const currentIndex =
                    bracketTabs.indexOf(tab);

                const direction =
                    event.key === "ArrowRight" ? 1 : -1;

                const nextIndex =
                    (currentIndex + direction + bracketTabs.length) %
                    bracketTabs.length;

                const nextTab =
                    bracketTabs[nextIndex];
                ...
                if (nextTab) {
                    ...
                    setBracket(
                        nextTab.getAttribute("data-bracket-tab")
                    );
    ...
    if (bracketTabs.length) {
        ...
        bracketTabs[0].setAttribute(
            "tabindex",
            "0"
        );

        setBracket(
            bracketTabs.find(tab =>
                tab.classList.contains("active")
            )?.getAttribute("data-bracket-tab") ||
            bracketTabs[0].getAttribute("data-bracket-tab")
        );
